package com.maf.telegram.outbox;

import com.maf.telegram.entity.OutboxEvent;
import com.maf.telegram.repository.OutboxEventRepository;
...
public class OutboxPublisher {
    ...
    @Scheduled(fixedDelayString = "${telegram.outbox.poll-delay-ms:1000}")
    @Transactional
